...
def main():
    ...
    # TESTED FUNCTIONS:
    # scan(interfaces) # TESTED: 
    trustedAPs(interfaces) # TESTED BUT NEEDS TODO: go to: line(10)
    # print(removeAPs(interfaces)) # TESTED
    # print(stayConnected(interfaces)) # TESTED: DONE.
    # killSwitch(interfaces) # TESTED: DONE.
    # print(stayConnected(interfaces)) # TESTED: DONE.

    #UNTESTED FUNCTIONS:
    scan(interfaces)
    addNew(interfaces)
    # If we use the Profile [built-in function] as trusted List we will have an issue
    trustedAPs(interfaces) 
